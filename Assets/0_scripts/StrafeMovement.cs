...
public class StrafeMovement : MonoBehaviour
{
    ...
    // Modified velocity of the player
    ...
    // Horizontal and vertical axis of the user input
    // Current velocity of the player
    // Additional velocity of the player
    ...
    // Current "up" velocity of the player (velocity.y)
    // Additional jump velocity for the player
    ...
    // True if the player touches the ground, false if not
